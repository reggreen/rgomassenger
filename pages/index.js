...
export default function Home() {
  ...
  return (
      ...
      <MainChatWindow
        ...
        setReplyMessage={(msg) => (msg ? handleReplyTo(msg) : handleCancelReply())}
        ...
        handleSendQuickLike={handleSendQuickLike}
        isSending={isSending}
        ...
        getAvatarForUsername={getAvatarForUsername}
        ...
        isPushRegistering={isPushRegistering}
        isSendingTestPush={isSendingTestPush}
        pushStatusMessage={pushStatusMessage}
        startCall={startCall}
        setIsTaskAlertModalOpen={setIsTaskAlertModalOpen}
